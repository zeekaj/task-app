...
export function DashboardView({ uid }: DashboardViewProps) {
  void uid;
  return (
  ...
  <p className="text-gray-400">{"Welcome back! Here's your team's performance snapshot."}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KPITile
          ...
          label="High Priority"
          value="1"
          subtitle="Critical & High priority tasks"
          color="orange"
        />
      </div>
